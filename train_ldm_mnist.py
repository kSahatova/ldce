...
class MNISTDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_ds = DDPMDataset('train', self.image_size, self.root, self.cfg_dropout)
        self.val_ds   = DDPMDataset('test',  self.image_size, self.root, cfg_dropout=0.0)
...
def main():
    ...
    print(f"  image_size  = {args.image_size}  (VAE latent: {args.image_size // 4}×{args.image_size // 4}×4)")
