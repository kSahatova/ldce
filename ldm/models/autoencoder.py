...
# taming-transformers ships its Python package as `taming/` inside the repo.
# Add the repo root to sys.path so `import taming` works whether or not the
# package has been pip-installed.
_TAMING_DIR = os.path.join(os.path.dirname(__file__), '..', '..', 'taming-transformers')
